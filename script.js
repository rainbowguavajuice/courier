...
(game) => (game.scream_counter > 0 ? 'times you have screamed: <span id="w_4"></span>.' : '')
];
let h_list = [
null,
(game) => ((e) => go_to(game, P_FOREST__SOUTH)),
...
let raw = '<p>you are at the room in the north (<span id="w_0"></span>).</p><p>you can <span id="w_1"></span> or <span id="w_2"></span>, or <span id="w_3"></span>. <span id="w_5"></span></p>';
render_passage(game, dom_parent, raw, e_list, h_list);
}
